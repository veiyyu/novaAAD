...
from decoder import _trial_cov, fit_decoder, save_decoder, default_meta
...
def main():
    ...
    if path.endswith(".npy"):
        path = path[:-4] + ".npz"
    meta = default_meta(trials[0]["eeg"].shape[1],
                        subject=(args.subject if args.eeg == "replay" else "live"),
                        split="personalized")
